...
proc create_root_design { parentCell } {
  ...
  # Create instance: leds_driver_0, and set properties
  set block_name leds_driver
  set block_cell_name leds_driver_0
  if { [catch {set leds_driver_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $leds_driver_0 eq "" } {
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_rgb/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_rgb/S_AXI/Reg] -force
